...
<%
    ...
    try {
        ...
        if (request.getParameter("Update") != null) {
            ...
            response.sendRedirect("MyProfileHelper.jsp?HId=" + HelID);
        }
    } catch (Exception e) {
        out.println(e);
    }
...
<html>
    ...
    <body style="background-image: url('Images/Capture18.PNG');background-size:cover;color: white">
        <script src="JavaScript/HelperInfoAdmin.js"></script>
        <div class="row pt-4" style="height: 80px;">
            <div class='col-md-5' style="font-size: 53px;font-style: italic;color: white;font-weight: 700">Plants On Wheels</div>
            ...
            <div class="col-md-1" style="padding: 20px;"><a href='MyProfileHelper.jsp?HId=<%=HId%>' style="background: none;color: white;width: inherit;
                                                            border: none;">My Profile</a></div>
            <div class="col-md-2" style="padding: 20px;text-align: center"><a href='MyAppointmentsHelper.jsp?HId=<%=HId%>' style="background: none;color: white;width: inherit;
            ...
            <div class="col-md-1" style="padding: 20px;"><a style="background: none;color: white;width: inherit;
        ...
        <div style="display: none;background-image:url('Images/Capture7.PNG');background-repeat: no-repeat;background-size:cover;
            ...
            <form class="form-container" style="padding: 20px">
                ...
                <div class="row mx-3">
                    <div class="col-md-4">
                        <label><b>Gardener's Name:</b></label>
                        <input type="text"  placeholder="Gardener's Name" name="HName" value="<%=resultSet.getString("HName")%>" />
                    </div>
                    <div class="col-md-4">
