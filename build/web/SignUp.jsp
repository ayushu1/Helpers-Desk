...
<html>
    ...
    <body style="background: url(Images/Capture16.PNG);background-repeat: no-repeat;background-position: center;height: 100%;
                ...
                <div>
                    ...
                    <div class="col-md-12" style="display: flex; text-align: center; padding-left: 5%;">
                        ...
                        <div class="col-md-4"><input type="radio" id="helper" value="3" name="Role" onclick="javascript:choose();" checked="true">
                            &nbsp;
                            <label for="helper"><b>As Gardener</b></label></div>
                        &nbsp;
                        ...
                        <div class="row mx-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="Occupation" name="HOccupation" style="width: 180px;">
                                    ...
                                    <option value="greenhouse technology">greenhouse technology</option>
