...
<html>
    ...
    <body  style="background: url(Images/Capture17.PNG);background-repeat: no-repeat;background-position: center;height: 100%;
                        ...
                        <div>
                            ...
                            <div class="col-md-12" style="display: flex; text-align: center">
                                ...
                                <div class="col-md-4"><input type="radio" id="admin" value="3" name="Role" onclick="javascript:choose();" checked="true">
                                    &nbsp;
                                    <label for="helper" style="color: white;" ><b>As Admin</b></label></div>

                                <div class="col-md-4"><input type="radio" id="plantSeller" value="3" name="Role" onclick="javascript:choose();">
                                    &nbsp;
                                    <label for="helper" style="color: white;"><b>As Plant Seller</b></label></div>
                              
                                <div class="col-md-4"><input type="radio" id="gardener" value="3" name="Role" onclick="javascript:choose();">
                                    &nbsp;
                                    <label for="helper" style="color: white;"><b>As Gardner</b></label></div>
                               
                                <div class="col-md-4"><input type="radio" id="user" value="4" name="Role" onclick="javascript:choose();">
                                    &nbsp;
                                    <label for="user" style="color: white;"><b>As User</b></label></div>
                            ...
                            <div id="admin1">
                                <form>
                                    ...
                                    <div class="col-md-12" style="margin-left: 1%;">
                                        <p>
                                            <b><a style="color: white;">Forgot your Password?</a></b>
                                        </p>
                                    </div>
                            ...
                            <!--helper-->
                            <div id="plantSeller1" style="display: none;">
                                <form>
                                    <div class="form-group display">
                                    ...
                                    <div class="form-element display">
                                        <input type="submit" value="Plant Seller Login" name ="btnHelper" style="width: 43%;background-color: black" class="btnSubmit">
                                    </div>
                                </form>
                            </div>
<!--                            gardener-->
                             <div id="gardener1" style="display: none;">
                                <form>
                                    <div class="form-group display">
                                        <input type="text" name="HId" class="form-control" id="HId" placeholder="User name/ Email ID" style="width: 43%;">
                                    </div>
                                    ...
                                    <div class="form-element display">
                                        <input type="submit" value="Gardener Login" name ="btnHelper" style="width: 43%;background-color: black" class="btnSubmit">
                                    </div>
                                </form>
                            </div>
                            <!--user-->
                            ...
                            <div class="col-md-12" style="margin-left: 1%;">
                                <p style="color: white;">
                                    <b>Don't&nbsp;have&nbsp;an&nbsp;account&nbsp;?&nbsp;<a style="color: red" href="SignUp.jsp">SignUp</a></b>
                                </p>
                            </div>
                ...
                <div style="padding-bottom: 8%; padding-top: 5%; text-align: center;color: white">
            ...
            <div class="col-md-6">
<!--                <br><br><br><br>
                <img src="Images/Capture14.PNG" class="img1">
                <br><br><br>-->
            </div>
        </div>        
