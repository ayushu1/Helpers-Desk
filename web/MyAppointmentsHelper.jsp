...
<html>
    ...
    <body style="background-image: url('Images/Capture7.PNG');background-repeat: no-repeat;background-size:cover;">
        ...
        <div class="row" style="background-image: url('Images/Capture5.PNG');background-repeat: no-repeat;height: 80px;">
            <div class='col-md-6' style="font-size: 53px;font-style: italic;color: white;font-weight: 700">Plants On Wheels</div>
                ...
                <div class="col-md-10" style="background-image:url('Images/Capture18.PNG');background-repeat: no-repeat;background-size:cover;color: white">
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">Appointment ID</th>
                                <th scope="col">Gaerdener's ID</th>
                                <th scope="col">User ID</th>
                                <th scope="col">Appointment Date</th>
                                <th scope="col">Apppointment Time</th>
                                <th scope="col">Address</th>
