<%-- 
    Document   : Home
    Created on : 19 Mar, 2021, 2:21:00 PM
    Author     : 91831
--%>
...
<html>
    ...
    <body style="background-image: url('Images/Capture19.PNG');background-repeat: no-repeat;">
        ...
        <div class="row pr-4">
            ...
            <div class="col-md-1"><a href="HomeAdmin.jsp" class="btn">Home</a></div>        
            <div class="col-md-2"><a href="HelperInfoAdmin.jsp" class="btn">Gardeners' Information</a></div>
            <div class="col-md-2"><a href="UserInfoAdmin.jsp" class="btn">User's Information</a></div>
             <div class="col-md-2"><a href="AppointmentsAdmin.jsp" class="btn">All Appointments</a></div>
<!--            <div class="col-md-1"><a href="HelpAdmin.jsp" class="btn">Help</a></div>-->
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <ul style="font-weight: 600;">
                    <li>Plants On Wheels is an online platform that would result in providing the necessary 
